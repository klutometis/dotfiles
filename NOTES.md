...
## 2026-02-27 - MCP Search, Scraping & Research Tools

See `~/notes/mcp-search-tools.md` for the current stack (Perplexity + Firecrawl + Context7), full comparison of alternatives (Linkup, Tavily, Exa, Brave, Jina, GPT Researcher), pricing, and notes on mcp-proxy tool filtering limitations.

**Summary:** Dropped Linkup (redundant with Firecrawl + Perplexity). Current 3-server stack covers web search, deep research, scraping, and docs lookup with minimal overlap.
